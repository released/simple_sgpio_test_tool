...
#define BRIDGE_INFO_NAME             "m261-sgpio-bridge/" M261_BRIDGE_FW_VERSION_STR
                                  ...
                                  uint8_t *out, uint16_t *out_len, uint8_t *status)
{
    switch (cmd)
    {
        case BRIDGE_CMD_SGPIO_CONFIG:
        {
            ...
            if (M261BridgeSgpio_Config(slot_count, clock_hz) == 0u)
            {
        ...
        case BRIDGE_CMD_SGPIO_APPLY:
        {
            ...
            if (M261BridgeSgpio_Apply(enable, periodic, interval_ms, sload_raw,
        ...
        case BRIDGE_CMD_SGPIO_STATUS:
        {
            ...
            if (M261BridgeSgpio_GetStatus(&enabled, &periodic, &slot_count, &clock_hz, &interval_ms, &sload_raw,
