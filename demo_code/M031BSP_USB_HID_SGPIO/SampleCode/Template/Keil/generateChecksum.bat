...
REM ============================================================
REM M032SE3AE APROM IAP layout
REM   Bootloader : 0x00000000 - 0x00003FFF
REM   Application: 0x00004000 - 0x0001FFFF
REM   CRC32 word : 0x0001FFFC - 0x0001FFFF
REM ============================================================
set "APP_HEX=.\obj\template.hex"
set "BOOT_HEX=..\..\ISP_HID\KEIL\obj\ISP_HID.hex"
set "SREC_EXE=.\srec_cat.exe"

set "APP_START=0x00004000"
set "APP_CRC_ADDR=0x0001FFFC"
set "APP_END_EXCL=0x00020000"
set "FLASH_START=0x00000000"
set "OUT_BLK=16"

set "APP_DIR=.\obj"
set "APP_HEX_BAK=%APP_DIR%\template_backup.hex"
set "APP_HEX_WITH_CRC=%APP_DIR%\template_CRC.hex"
set "APP_BIN_WITH_CRC=%APP_DIR%\template.bin"
